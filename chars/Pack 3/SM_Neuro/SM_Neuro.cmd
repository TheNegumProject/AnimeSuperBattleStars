...
;SPECIALS:
;===========================================================================
; 777 tools Evil Shooter
[State -1, 777 tools Evil Shooter]
type = ChangeState
triggerall = pos y = 0
...
;---------------------------------------------------------------------------
; 777 tools Evil Friday
[State -1, 777 tools Evil Friday]
type = ChangeState
Triggerall = power >= 1000
value = 1100
triggerall = command = "SPECIAL 1"
...
trigger1 = ctrl
;---------------------------------------------------------------------------
; 777 tools Evil Full face
[State -1, 777 tools Evil Full face]
type = ChangeState
...
trigger1 = ctrl
;---------------------------------------------------------------------------
; Super Doping Soup Attack!
[State -1, Super Doping Soup Attack!]
type = ChangeState
